...
<form action="listServlet" method="post">	
  <div class="row-fluid sortable">		
		       ...
		       <c:forEach items="${details }" var="detail">	  						  					  														
							<tr>
								<td>${detail.id }</td>
								<td class="center">${detail.title}</td>
								<td class="center">${detail.author}</td>
								<td class="center">${detail.summary }</td>
								<td class="center">${detail.createDate }</td>								
								<td class="center">
									<a class="btn btn-success" href="FindCategoryServlet">
										<i class="icon-zoom-in icon-white"></i>  
										新增                                          
									</a>
									<a class="btn btn-info" href="findByIdServlet?id=${detail.id }">
										<i class="icon-edit icon-white"></i>  
										修改                                           
									</a>
									<a class="btn btn-danger" href="#" onClick="del('delServlet?id=${detail.id }');">
